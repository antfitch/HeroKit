...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AbilityTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Ability Type";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.abilityTypeProperties);
        }
