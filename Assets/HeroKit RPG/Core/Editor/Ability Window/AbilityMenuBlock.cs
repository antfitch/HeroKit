...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AbilityMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Ability";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.abilityDatabase_attributes.propertiesList.properties;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.abilityProperties);
        }
