...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AffixesTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Affix Type";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.affixTypeProperties);
        }
