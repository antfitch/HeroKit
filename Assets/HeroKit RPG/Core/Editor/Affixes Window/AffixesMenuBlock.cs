...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AffixesMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Affix";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.affixDatabase_attributes.propertiesList.properties;
