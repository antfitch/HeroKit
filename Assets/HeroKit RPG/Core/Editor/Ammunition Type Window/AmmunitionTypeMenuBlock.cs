...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AmmunitionTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Weapon Type";
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        static AmmunitionTypeMenuBlock()
        {
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.ammunitionTypeProperties);
        }
