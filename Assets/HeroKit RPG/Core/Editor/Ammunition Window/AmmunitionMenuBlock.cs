...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class AmmunitionMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Ammunition";
        /// <summary>
        ...
        private static List<HeroState> states;
        private static List<HeroState>savedStatesList;
        private static readonly LinkedList<HeroState> deletedStates;
        private static readonly LinkedList<int> deletedStatesIndex;
        ...
        static AmmunitionMenuBlock()
        {
            ...
            deletedStates = new LinkedList<HeroState>();
            deletedStatesIndex = new LinkedList<int>();
        }
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.ammunitionDatabase_attributes.propertiesList.properties;
            states = heroObject.states.states;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.ammunitionProperties);
        }
        ...
        private static void moveItemUp(object obj)
        {
            ...
            HeroKitCommon.moveItemUp(states, index);
        }
        /// <summary>
        /// Move item down.
        /// </summary>
        ...
        private static void moveItemDown(object obj)
        {
            ...
            HeroKitCommon.moveItemDown(states, index);
        }
        /// <summary>
        ...
        private static void addItem()
        {
            ...
            HeroKitCommon.addItem(states, new HeroState());
            initState(states.Count - 1);       
        }
        /// <summary>
        ...
        public static void addItemAbove(object obj)
        {
            ...
            HeroKitCommon.addItem(states, new HeroState(), index);
            initState(index);
        }
        /// <summary>
        ...
        private static void copyItem(object obj)
        {
            ...
            savedStatesList = HeroKitCommon.copyState(states, savedStatesList, index);
        }
        /// <summary>
        ...
        public static void pasteItemAbove(object obj)
        {
            ...
            HeroKitCommon.pasteState(states, savedStatesList, index);
        }
        /// <summary>
        ...
        public static void pasteItemHere(object obj)
        {
            ...
            HeroKitCommon.pasteStateHere(states, savedStatesList, index);
        }
        /// <summary>
        ...
        private static void deleteItem(object obj)
        {
            ...
            HeroKitCommon.deleteItem(items, deletedFields, deletedFieldsIndex, blockName, index);
            HeroKitCommon.deleteItem(attributes, deletedAttributes, deletedAttributesIndex, "", index);
            HeroKitCommon.deleteState(states, deletedStates, deletedStatesIndex, "", index);
        }
        /// <summary>
        ...
        // initialize the state that contains the actions for the item
        private static void initState(int index)
        {
            states[index].heroEvent.Add(new HeroEvent());
            states[index].heroEvent[0].eventType = 4; // called by action
        }
    }
}