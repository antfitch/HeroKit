...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class ArmorTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Armor Type";
        /// <summary>
        ...
        {
            HeroKit.Editor.HeroKitCommon.DrawMenuItems("Armor Type", deleteItem, addItem);
            DrawItems();
        }
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.armorTypeProperties);  
        }
