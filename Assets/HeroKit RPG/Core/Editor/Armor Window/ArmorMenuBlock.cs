...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class ArmorMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Armor";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.armorDatabase_attributes.propertiesList.properties;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.armorProperties);
        }
