...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class CharacterTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Character Type";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.characterTypeProperties);
        }
