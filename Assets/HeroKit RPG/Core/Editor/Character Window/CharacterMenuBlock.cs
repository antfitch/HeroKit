...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class CharacterMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Character";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.characterDatabase_attributes.propertiesList.properties;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.characterProperties);
        }
