...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class ElementTypeMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Element Type";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.elementTypeProperties);
        }
