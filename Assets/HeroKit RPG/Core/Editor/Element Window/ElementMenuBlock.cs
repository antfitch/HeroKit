...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class ElementMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Element";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.elementProperties);
        }
