...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class ItemMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Item";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.itemDatabase_attributes.propertiesList.properties;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.itemProperties);
        }
