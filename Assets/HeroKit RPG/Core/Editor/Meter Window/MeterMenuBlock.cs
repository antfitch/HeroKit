...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class MeterMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Meter";
        /// <summary>
        ...
        {
            HeroKit.Editor.HeroKitCommon.DrawAddNewItem("Item", addItem, Button.StyleAddMenuItem, indentMenu);
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.meterProperties);
        }
