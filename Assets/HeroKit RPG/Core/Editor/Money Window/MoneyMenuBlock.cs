...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class MoneyMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Currency";
        /// <summary>
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.moneyProperties);
        }
