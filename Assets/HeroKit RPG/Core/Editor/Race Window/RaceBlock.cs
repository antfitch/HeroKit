...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal static class RaceBlock
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private static string blockName = "Race";
        /// <summary>
        /// The Hero Property.
        /// </summary>
        ...
        public static void Block(HeroObject heroKitObject, int indexProperty)
        {
            ...
            attributeBlock = HeroKitCommon.raceDatabase_attributes.propertiesList.properties[itemIndex];
