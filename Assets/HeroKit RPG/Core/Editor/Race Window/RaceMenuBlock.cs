...
namespace HeroKit.RpgEditor
{
    ...
    /// </summary>
    internal class RaceMenuBlock : EditorWindow
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private const string blockName = "Race";
        /// <summary>
        ...
        public static void Block(HeroObject heroKitObject)
        {
            ...
            attributes = HeroKitCommon.raceDatabase_attributes.propertiesList.properties;
        ...
        {
            return HeroKitCommon.getHeroProperties(HeroKitCommon.raceProperties);
        }
