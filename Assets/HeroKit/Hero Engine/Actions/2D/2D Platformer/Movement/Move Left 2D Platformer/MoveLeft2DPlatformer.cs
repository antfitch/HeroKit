...
namespace HeroKit.Scene.Actions
{
    ...
    /// Move an object left.
    /// </summary>
    public class MoveLeft2DPlatformer : IHeroKitAction
    {
        ...
        public static MoveLeft2DPlatformer Create()
        {
            MoveLeft2DPlatformer action = new MoveLeft2DPlatformer();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveLeft;
