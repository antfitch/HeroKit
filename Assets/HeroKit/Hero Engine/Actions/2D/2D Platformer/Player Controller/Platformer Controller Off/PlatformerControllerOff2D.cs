...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class PlatformerControllerOff2D : IHeroKitAction
    {
        ...
        public static PlatformerControllerOff2D Create()
        {
            PlatformerControllerOff2D action = new PlatformerControllerOff2D();
            return action;
        }
