...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Move an object away from the direction it is facing.
    /// </summary>
    public class MoveBackward2D : IHeroKitAction
    {
        ...
        public static MoveBackward2D Create()
        {
            MoveBackward2D action = new MoveBackward2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveOpposite;
