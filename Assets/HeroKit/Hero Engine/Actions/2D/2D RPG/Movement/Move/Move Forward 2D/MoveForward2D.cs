...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Move an object in the direction it is facing.
    /// </summary>
    public class MoveForward2D : IHeroKitAction
    {
        ...
        public static MoveForward2D Create()
        {
            MoveForward2D action = new MoveForward2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveForward;
