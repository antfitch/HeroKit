...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Move an object lower right.
    /// </summary>
    public class MoveLowerRight2D : IHeroKitAction
    {
        ...
        public static MoveLowerRight2D Create()
        {
            MoveLowerRight2D action = new MoveLowerRight2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveRightDown;
