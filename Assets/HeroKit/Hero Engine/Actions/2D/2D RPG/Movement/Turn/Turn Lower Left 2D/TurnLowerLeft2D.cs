...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Turn an object lower left.
    /// </summary>
    public class TurnLowerLeft2D : IHeroKitAction
    {
        ...
        public static TurnLowerLeft2D Create()
        {
            TurnLowerLeft2D action = new TurnLowerLeft2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveLeftDown;
