...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Turn an object lower right.
    /// </summary>
    public class TurnLowerRight2D : IHeroKitAction
    {
        ...
        public static TurnLowerRight2D Create()
        {
            TurnLowerRight2D action = new TurnLowerRight2D();
            return action;
        }
