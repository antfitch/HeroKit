...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Turn an object in a random direction.
    /// </summary>
    public class TurnRandom2D : IHeroKitAction
    {
        ...
        public static TurnRandom2D Create()
        {
            TurnRandom2D action = new TurnRandom2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveRandom;
