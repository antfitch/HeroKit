...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Turn an object upper left.
    /// </summary>
    public class TurnUpperLeft2D : IHeroKitAction
    {
        ...
        public static TurnUpperLeft2D Create()
        {
            TurnUpperLeft2D action = new TurnUpperLeft2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveLeftUp;
