...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Have the 2D camera stop following a hero object.
    /// </summary>
    public class OrthoCameraOff : IHeroKitAction
    {
        ...
        public static OrthoCameraOff Create()
        {
            OrthoCameraOff action = new OrthoCameraOff();
            return action;
        }
