...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Don't face move direction when object moves.
    /// </summary>
    public class FaceMoveDirectionOff2D : IHeroKitAction
    {
        ...
        public static FaceMoveDirectionOff2D Create()
        {
            FaceMoveDirectionOff2D action = new FaceMoveDirectionOff2D();
            return action;
        }
