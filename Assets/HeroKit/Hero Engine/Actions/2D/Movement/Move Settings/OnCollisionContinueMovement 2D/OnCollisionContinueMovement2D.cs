...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Keep moving forward if this object collides with another object.
    /// </summary>
    public class OnCollisionContinueMovement2D : IHeroKitAction
    {
        ...
        public static OnCollisionContinueMovement2D Create()
        {
            OnCollisionContinueMovement2D action = new OnCollisionContinueMovement2D();
            return action;
        }
