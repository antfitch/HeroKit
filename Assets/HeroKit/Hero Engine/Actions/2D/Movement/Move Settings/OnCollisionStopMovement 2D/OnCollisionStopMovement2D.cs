...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class OnCollisionStopMovement2D : IHeroKitAction
    {
        ...
        public static OnCollisionStopMovement2D Create()
        {
            OnCollisionStopMovement2D action = new OnCollisionStopMovement2D();
            return action;
        }
