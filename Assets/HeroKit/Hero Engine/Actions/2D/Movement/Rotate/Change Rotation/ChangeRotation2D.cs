...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class ChangeRotation2D : IHeroKitAction
    {
        ...
        public static ChangeRotation2D Create()
        {
            ChangeRotation2D action = new ChangeRotation2D();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, string childName)
        {
            ...
            if (transform != null)
            {
                ...
                // change the rotation
                transform.localEulerAngles = degrees;
            }
        }
