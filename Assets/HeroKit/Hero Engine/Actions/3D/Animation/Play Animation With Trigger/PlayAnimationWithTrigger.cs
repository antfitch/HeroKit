...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class PlayAnimationWithTrigger : IHeroKitAction
    {
        ...
        public static PlayAnimationWithTrigger Create()
        {
            PlayAnimationWithTrigger action = new PlayAnimationWithTrigger();
            return action;
        }
