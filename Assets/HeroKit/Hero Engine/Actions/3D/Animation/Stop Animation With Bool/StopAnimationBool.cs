...
{
    /// <summary>
    /// Turn off a bool in an animator
    /// </summary>
    public class StopAnimationBool : IHeroKitAction
    {
        ...
        public static StopAnimationBool Create()
        {
            StopAnimationBool action = new StopAnimationBool();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            {
                string debugMessage = animationName + ": " + false;
