...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Have the first person camera stop following a hero object.
    /// </summary>
    public class FirstPersonCameraOff : IHeroKitAction
    {
        ...
        public static FirstPersonCameraOff Create()
        {
            FirstPersonCameraOff action = new FirstPersonCameraOff();
            return action;
        }
