...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Have the third-person camera follow a hero object.
    /// </summary>
    public class ThirdPersonCameraOn : IHeroKitAction
    {
        ...
        public static ThirdPersonCameraOn Create()
        {
            ThirdPersonCameraOn action = new ThirdPersonCameraOn();
            return action;
        }
