...
{
    /// <summary>
    /// Raise a hero kit object and let it float.
    /// </summary>
    public static class FloatFields
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            GetHeroObjectField.BuildFieldE("Float a different object?", actionParams, heroAction.actionFields[0], heroAction.actionFields[1]);
