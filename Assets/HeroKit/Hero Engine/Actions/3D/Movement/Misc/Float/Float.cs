...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Rise an object from the ground and let it float.
    /// </summary>
    public class Float : IHeroKitAction
    {
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, float timeToWait, float speed)
        {
            ...
            heroObjectMove = targetObject.GetHeroComponent<HeroFloat3D>("HeroFloat3D", true);
        ...
        // Long Update Data
        // ---------------------------------------
        private HeroFloat3D heroObjectMove;
        private bool wait;
