...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Don't animate the object when it moves.
    /// </summary>
    public class AnimateMoveOff : IHeroKitAction
    {
        ...
        public static AnimateMoveOff Create()
        {
            AnimateMoveOff action = new AnimateMoveOff();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.settings.animate = false;
        }
