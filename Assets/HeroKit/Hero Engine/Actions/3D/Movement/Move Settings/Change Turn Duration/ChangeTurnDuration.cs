...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class ChangeTurnDuration : IHeroKitAction
    {
        ...
        public static ChangeTurnDuration Create()
        {
            ChangeTurnDuration action = new ChangeTurnDuration();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, float duration)
        {
            ...
            moveObject.settings.turnDuration = duration;
        }
