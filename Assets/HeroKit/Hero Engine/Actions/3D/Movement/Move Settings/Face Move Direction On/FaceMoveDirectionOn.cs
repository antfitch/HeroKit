...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class FaceMoveDirectionOn : IHeroKitAction
    {
        ...
        public static FaceMoveDirectionOn Create()
        {
            FaceMoveDirectionOn action = new FaceMoveDirectionOn();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.settings.faceDirection = true;
        }
