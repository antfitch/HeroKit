...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class OnCollisionContinueMovement : IHeroKitAction
    {
        ...
        public static OnCollisionContinueMovement Create()
        {
            OnCollisionContinueMovement action = new OnCollisionContinueMovement();
            return action;
        }
