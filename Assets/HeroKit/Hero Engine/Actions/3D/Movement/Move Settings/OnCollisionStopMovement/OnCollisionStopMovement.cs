...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Stop moving if this object collides with another object.
    /// </summary>
    public class OnCollisionStopMovement : IHeroKitAction
    {
        ...
        public static OnCollisionStopMovement Create()
        {
            OnCollisionStopMovement action = new OnCollisionStopMovement();
            return action;
        }
