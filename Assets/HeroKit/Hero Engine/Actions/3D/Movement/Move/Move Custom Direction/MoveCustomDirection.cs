...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Move an object in a custom direction.
    /// </summary>
    public class MoveCustomDirection : IHeroKitAction
    {
        ...
        public static MoveCustomDirection Create()
        {
            MoveCustomDirection action = new MoveCustomDirection();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, int angle)
        {
            ...
            moveObject.Move = moveObject.MoveCustom;
