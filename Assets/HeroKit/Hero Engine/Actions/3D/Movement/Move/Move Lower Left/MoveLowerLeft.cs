...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class MoveLowerLeft : IHeroKitAction
    {
        ...
        public static MoveLowerLeft Create()
        {
            MoveLowerLeft action = new MoveLowerLeft();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveLowerLeft;
