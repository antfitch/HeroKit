...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class MoveLowerRight : IHeroKitAction
    {
        ...
        public static MoveLowerRight Create()
        {
            MoveLowerRight action = new MoveLowerRight();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveLowerRight;
