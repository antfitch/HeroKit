...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class MoveUpperLeft : IHeroKitAction
    {
        ...
        public static MoveUpperLeft Create()
        {
            MoveUpperLeft action = new MoveUpperLeft();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveUpperLeft;
