...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Move an object upper right.
    /// </summary>
    public class MoveUpperRight : IHeroKitAction
    {
        ...
        public static MoveUpperRight Create()
        {
            MoveUpperRight action = new MoveUpperRight();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.MoveUpperRight;
