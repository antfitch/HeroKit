...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Stop moving an object along a path toward a position in the scene.
    /// </summary>
    public class NavigateTowardPositionOff : IHeroKitAction
    {
        ...
        public static NavigateTowardPositionOff Create()
        {
            NavigateTowardPositionOff action = new NavigateTowardPositionOff();
            return action;
        }
