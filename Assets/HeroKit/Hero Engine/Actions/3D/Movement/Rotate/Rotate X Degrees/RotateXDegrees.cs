...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class RotateXDegrees : IHeroKitAction
    {
        ...
        public static RotateXDegrees Create()
        {
            RotateXDegrees action = new RotateXDegrees();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            if (changeX) degrees.z = IntegerFieldValue.GetValueA(heroKitObject, 3);
            bool changeY = BoolValue.GetValue(heroKitObject, 4);
            if (changeY) degrees.y = IntegerFieldValue.GetValueA(heroKitObject, 5);
            bool changeZ = BoolValue.GetValue(heroKitObject, 6);
            if (changeZ) degrees.x = IntegerFieldValue.GetValueA(heroKitObject, 7);
