...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Turn an object in a custom direction.
    /// </summary>
    public class TurnCustomDirection : IHeroKitAction
    {
        ...
        public static TurnCustomDirection Create()
        {
            TurnCustomDirection action = new TurnCustomDirection();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, int angle)
        {
            // get the movement script
            moveObject = targetObject.GetHeroComponent<HeroMove3D>("HeroMove3D", true);
            moveObject.turnAngle = angle;
            moveObject.Move = moveObject.TurnCustom;
