...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class TurnLowerLeft : IHeroKitAction
    {
        ...
        public static TurnLowerLeft Create()
        {
            TurnLowerLeft action = new TurnLowerLeft();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.TurnLowerLeft;
