...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class TurnUpperLeft : IHeroKitAction
    {
        ...
        public static TurnUpperLeft Create()
        {
            TurnUpperLeft action = new TurnUpperLeft();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.TurnUpperLeft;
