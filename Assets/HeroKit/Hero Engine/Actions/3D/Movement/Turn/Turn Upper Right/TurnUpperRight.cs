...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class TurnUpperRight : IHeroKitAction
    {
        ...
        public static TurnUpperRight Create()
        {
            TurnUpperRight action = new TurnUpperRight();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject)
        {
            ...
            moveObject.Move = moveObject.TurnUpperRight;
