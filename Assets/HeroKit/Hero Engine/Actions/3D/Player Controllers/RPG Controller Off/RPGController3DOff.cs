...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Disable RPG player controller.
    /// </summary>
    public class RPGController3DOff : IHeroKitAction
    {
        ...
        public static RPGController3DOff Create()
        {
            RPGController3DOff action = new RPGController3DOff();
            return action;
        }
