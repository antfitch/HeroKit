...
namespace HeroKit.Editor.ActionBlockFields
{
    ...
    /// </summary> 
    public static class PlayBGSFields
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            SimpleLayout.BeginVertical(SimpleGUI.Fields.Box.StyleB);
            GetUnityObjectField.BuildFieldA<AudioClip>("The background sound effect to play:", actionParams, heroAction.actionFields[2]);
            SimpleLayout.EndVertical();

            SimpleLayout.BeginVertical(SimpleGUI.Fields.Box.StyleB);
            bool changeSettings = GetBoolValue.BuildField("Change BGS settings?", actionParams, heroAction.actionFields[3], true);
            if (changeSettings)
            {
