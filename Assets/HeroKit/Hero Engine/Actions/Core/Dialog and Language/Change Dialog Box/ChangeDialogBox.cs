...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Change the prefab for the dialog box.
    /// </summary>
    public class ChangeDialogBox : IHeroKitAction
    {
        ...
        public static ChangeDialogBox Create()
        {
            ChangeDialogBox action = new ChangeDialogBox();
            return action;
        }
