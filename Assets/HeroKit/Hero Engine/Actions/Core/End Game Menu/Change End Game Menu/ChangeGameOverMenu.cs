...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Change the prefab for the game over menu.
    /// </summary>
    public class ChangeGameOverMenu : IHeroKitAction
    {
        ...
        public static ChangeGameOverMenu Create()
        {
            ChangeGameOverMenu action = new ChangeGameOverMenu();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            if (runThis)
            {
                ...
                GameObject prefab = HeroKitCommonRuntime.settingsInfo.gameoverMenu;
                if (prefab != null && prefab != menuTemplate)
                {
                    HeroKitCommonRuntime.DeletePrefabFromScene(prefab, true);
                    HeroKitCommonRuntime.settingsInfo.gameoverMenu = menuTemplate;
                }
            }
