...
namespace HeroKit.Scene.Actions
{
    ...
    /// Play an event.
    /// </summary>
    public class PlayEventByID : IHeroKitAction
    {
        ...
        public static PlayEventByID Create()
        {
            PlayEventByID action = new PlayEventByID();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            int stateID = IntegerFieldValue.GetValueA(heroKitObject, 2);
            eventID = IntegerFieldValue.GetValueA(heroKitObject, 3);
