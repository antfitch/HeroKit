...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Wait X number of milliseconds before performing the next action.
    /// </summary>
    public class WaitMilliseconds : IHeroKitAction
    {
        ...
        public static WaitMilliseconds Create()
        {
            WaitMilliseconds action = new WaitMilliseconds();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            // assign variables
            heroKitObject = hko;
            float millisecondsToWait = IntegerFieldValue.GetValueA(heroKitObject, 0) * 0.001f;
            timeToWait = millisecondsToWait + Time.time;
            ...
            {
                string debugMessage = "Milliseconds to wait: " + millisecondsToWait;
