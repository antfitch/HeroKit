...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// A conditional statement that checks if the result is true (game objects).
    /// If the result is true, actions inside the conditional statement are executed.
    /// Otherwise, the actions are skipped.
    /// </summary>
    public class IfGameObject : IHeroKitAction
    {
        ...
        public static IfGameObject Create()
        {
            IfGameObject action = new IfGameObject();
            return action;
        }
