...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// A conditional statement that checks if the result is true (hero kit object count).
    /// If the result is true, actions inside the conditional statement are executed.
    /// Otherwise, the actions are skipped.
    /// </summary>
    public class IfHeroCount : IHeroKitAction
    {
        ...
        public static IfHeroCount Create()
        {
            IfHeroCount action = new IfHeroCount();
            return action;
        }
