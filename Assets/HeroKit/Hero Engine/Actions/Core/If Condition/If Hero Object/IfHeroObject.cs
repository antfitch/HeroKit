...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// A conditional statement that checks if the result is true (hero object).
    /// If the result is true, actions inside the conditional statement are executed.
    /// Otherwise, the actions are skipped.
    /// </summary>
    public class IfHeroObject : IHeroKitAction
    {
        ...
        public static IfHeroObject Create()
        {
            IfHeroObject action = new IfHeroObject();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            HeroKitObject value1 = HeroObjectFieldValue.GetValueB(heroKitObject, 1)[0];
            HeroKitObject value2 = HeroObjectFieldValue.GetValueA(heroKitObject, 3)[0];
