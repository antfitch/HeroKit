...
namespace HeroKit.Scene.Actions
{
    ...
    public class IfInteger : IHeroKitAction
    {
        ...
        public static IfInteger Create()
        {
            IfInteger action = new IfInteger();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            {
                string debugMessage = "Int A: " + value1 + "\n" +
                                      "Int B: " + value2 + "\n" +
                                      "Result: " + evaluation;
