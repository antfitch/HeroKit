...
namespace HeroKit.Scene.Actions
{
    ...
    public class IfString : IHeroKitAction
    {
        ...
        public static IfString Create()
        {
            IfString action = new IfString();
            return action;
        }
