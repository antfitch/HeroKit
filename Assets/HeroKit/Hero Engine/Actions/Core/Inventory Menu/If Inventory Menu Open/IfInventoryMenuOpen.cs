...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Check to see if the inventory menu is open.
    /// </summary>
    public class IfInventoryMenuOpen : IHeroKitAction
    {
        ...
        public static IfInventoryMenuOpen Create()
        {
            IfInventoryMenuOpen action = new IfInventoryMenuOpen();
            return action;
        }
