...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Check to see if the journal menu is open.
    /// </summary>
    public class IfJournalMenuOpen : IHeroKitAction
    {
        ...
        public static IfJournalMenuOpen Create()
        {
            IfJournalMenuOpen action = new IfJournalMenuOpen();
            return action;
        }
