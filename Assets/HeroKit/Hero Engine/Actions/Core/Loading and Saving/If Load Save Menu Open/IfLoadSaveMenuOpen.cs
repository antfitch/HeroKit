...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Check to see if the save game menu or load game menu is open.
    /// </summary>
    public class IfLoadSaveMenuOpen : IHeroKitAction
    {
        ...
        public static IfLoadSaveMenuOpen Create()
        {
            IfLoadSaveMenuOpen action = new IfLoadSaveMenuOpen();
            return action;
        }
