...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Change the prefab for the options menu.
    /// </summary>
    public class ChangeOptionsMenu : IHeroKitAction
    {
        ...
        public static ChangeOptionsMenu Create()
        {
            ChangeOptionsMenu action = new ChangeOptionsMenu();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            if (runThis)
            {
                ...
                GameObject prefab = HeroKitCommonRuntime.settingsInfo.optionsMenu;
                if (prefab != null && prefab != menuTemplate)
                {
                    HeroKitCommonRuntime.DeletePrefabFromScene(prefab, true);
                    HeroKitCommonRuntime.settingsInfo.optionsMenu = menuTemplate;
                }
            }
