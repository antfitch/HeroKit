...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Check to see if the options menu is open.
    /// </summary>
    public class IfOptionsMenuOpen : IHeroKitAction
    {
        ...
        public static IfOptionsMenuOpen Create()
        {
            IfOptionsMenuOpen action = new IfOptionsMenuOpen();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            HeroKitObject targetObject = HeroKitCommonRuntime.GetPrefabFromAssets("HeroKit Options Menu", "Hero Templates/Menus/", true);
