...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Get specific hero objects in a hero object list. Only get objects that are in range of a specific coordinate.
    /// </summary>
    public class FilterHeroObjectsByDistance : IHeroKitAction
    {
