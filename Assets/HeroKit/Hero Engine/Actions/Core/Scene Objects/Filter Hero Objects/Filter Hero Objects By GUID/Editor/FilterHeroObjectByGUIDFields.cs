...
{
    /// <summary>
    /// Filter hero kit objects in a hero object list field by GUID.
    /// </summary>
    public static class FilterHeroObjectByGUIDFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            SimpleLayout.Label("Get hero objects in the list with this hero GUID:");
            GetIntegerField.BuildFieldA("", actionParams, heroAction.actionFields[3], true);
