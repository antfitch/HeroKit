...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Get specific hero objects in a hero object list. Only get objects that have a specific GUID.
    /// </summary>
    public class FilterHeroObjectsByGUID : IHeroKitAction
    {
        ...
        public static FilterHeroObjectsByGUID Create()
        {
            FilterHeroObjectsByGUID action = new FilterHeroObjectsByGUID();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            List<HeroKitObject> filteredObjects = HeroActionCommonRuntime.GetHeroObjectsByGUID(arrayObjects, objectCount, heroGuid);
