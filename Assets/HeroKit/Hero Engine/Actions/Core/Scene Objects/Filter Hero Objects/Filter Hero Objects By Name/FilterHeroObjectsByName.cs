...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Get specific hero objects in a hero object list. Only get objects that have a specific name.
    /// </summary>
    public class FilterHeroObjectsByName : IHeroKitAction
    {
        ...
        public static FilterHeroObjectsByName Create()
        {
            FilterHeroObjectsByName action = new FilterHeroObjectsByName();
            return action;
        }
