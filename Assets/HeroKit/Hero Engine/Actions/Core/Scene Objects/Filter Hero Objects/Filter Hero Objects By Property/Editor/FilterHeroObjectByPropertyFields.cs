...
{
    /// <summary>
    /// Filter hero kit objects in a hero object list field by property.
    /// </summary>
    public static class FilterHeroObjectByPropertyFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            SimpleLayout.Label("Get hero objects in the list that use this hero property:");
            GetHeroPropertyField.BuildField("", actionParams, heroAction.actionFields[3]);
