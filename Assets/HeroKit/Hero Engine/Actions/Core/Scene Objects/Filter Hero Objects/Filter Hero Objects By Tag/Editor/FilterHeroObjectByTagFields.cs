...
{
    /// <summary>
    /// Filter hero kit objects in a hero object list field by tag.
    /// </summary>
    public static class FilterHeroObjectByTagFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            SimpleLayout.Label("Keep hero objects with the following tag:");
            GetTagField.BuildField("", actionParams, heroAction.actionFields[3]);
