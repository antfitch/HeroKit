...
{
    /// <summary>
    /// Filter hero kit objects in a hero object list field by hero object type.
    /// </summary>
    public static class FilterHeroObjectByTypeFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            SimpleLayout.Label("Get hero objects in the list that are this hero type:");
            GetHeroTypeField.BuildField("", actionParams, heroAction.actionFields[3]);
