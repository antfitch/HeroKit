...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Get specific hero objects in a hero object list. Only get objects that are a specific type of hero object.
    /// </summary>
    public class FilterHeroObjectsByType : IHeroKitAction
    {
        ...
        public static FilterHeroObjectsByType Create()
        {
            FilterHeroObjectsByType action = new FilterHeroObjectsByType();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            List<HeroKitObject> filteredObjects = HeroActionCommonRuntime.GetHeroObjectsByType(arrayObjects, objectCount, heroType);
