...
{
    /// <summary>
    /// Get all hero kit objects from the scene.
    /// </summary>
    public class GetAllHeroObjectsInScene : IHeroKitAction
    {
        ...
        public static GetAllHeroObjectsInScene Create()
        {
            GetAllHeroObjectsInScene action = new GetAllHeroObjectsInScene();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            List<HeroKitObject> filteredObjects = HeroActionCommonRuntime.GetHeroObjects(HeroActionCommonRuntime.GetHeroObjectsInScene(), objectCount);
