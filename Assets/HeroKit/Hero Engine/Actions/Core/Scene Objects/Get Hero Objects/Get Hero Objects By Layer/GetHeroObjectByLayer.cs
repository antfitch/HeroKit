...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class GetHeroObjectByLayer : IHeroKitAction
    {
        ...
        public static GetHeroObjectByLayer Create()
        {
            GetHeroObjectByLayer action = new GetHeroObjectByLayer();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            List<HeroKitObject> filteredObjects = HeroActionCommonRuntime.GetHeroObjectsByLayer(HeroActionCommonRuntime.GetHeroObjectsInScene(), objectCount, layer);
