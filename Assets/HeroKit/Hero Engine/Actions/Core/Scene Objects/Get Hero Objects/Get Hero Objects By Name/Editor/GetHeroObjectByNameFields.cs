...
namespace HeroKit.Editor.ActionBlockFields
{
    ...
    /// </summary>
    public static class GetHeroObjectByNameFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            GetStringField.BuildFieldA("Get hero objects in the scene with the following name:", actionParams, heroAction.actionFields[3]);
