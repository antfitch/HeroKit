...
namespace HeroKit.Scene.Actions
{
    ...
    /// </summary>
    public class GetHeroObjectByRay : IHeroKitAction
    {
        ...
        public static GetHeroObjectByRay Create()
        {
            GetHeroObjectByRay action = new GetHeroObjectByRay();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            if (rayType == 2)
            {
                HeroKitObject targetObject = HeroObjectFieldValue.GetValueA(heroKitObject, 3)[0];
            ...
            List<HeroKitObject> filteredObjects = HeroActionCommonRuntime.GetHeroObjectsRay(objectCount, originObject, rayType, rayDirectionType, rayDistance, debugRay);
