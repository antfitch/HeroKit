...
namespace HeroKit.Editor.ActionBlockFields
{
    ...
    /// </summary>
    public static class GetHeroObjectByTagFields 
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            GetTagField.BuildField("Get hero objects in the scene with the following tag:", actionParams, heroAction.actionFields[3]);
