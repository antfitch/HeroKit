...
{
    /// <summary>
    /// Disable a component on an object.
    /// </summary>
    public class DisableComponent : IHeroKitAction
    {
        ...
        public static DisableComponent Create()
        {
            DisableComponent action = new DisableComponent();
            return action;
        }
