...
{
    /// <summary>
    /// Get a property in a component on an object.
    /// </summary>
    public class GetProperty : IHeroKitAction
    {
        ...
        public static GetProperty Create()
        {
            GetProperty action = new GetProperty();
            return action;
        }
        ...
        public void ExecuteOnTarget(HeroKitObject targetObject, string scriptName)
        {
            ...
            PropertyValue.SetValueB(targetObject, 3, 4, component);
        }
