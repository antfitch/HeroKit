...
namespace HeroKit.Editor.ActionBlockFields
{
    ...
    /// </summary>
    public static class SetFieldInfoFields
    {
        public static void BuildField(HeroActionParams actionParams)
        {
            ...
            if (script != null)
            {
                GetFieldInfoField.BuildFieldA("The field to set in the script:", actionParams, heroAction.actionFields[3], heroAction.actionFields[4], script);
            }
            SimpleLayout.EndVertical();
        }
    }
