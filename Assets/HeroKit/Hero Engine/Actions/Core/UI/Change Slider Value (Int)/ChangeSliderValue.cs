...
namespace HeroKit.Scene.Actions
{
    ...
    /// <summary>
    /// Change a UI slider value (ints).
    /// </summary>
    public class ChangeSliderValue : IHeroKitAction
    {
        ...
        public static ChangeSliderValue Create()
        {
            ChangeSliderValue action = new ChangeSliderValue();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            int value = IntegerFieldValue.GetValueA(heroKitObject, 2);
            Slider slider = null;
