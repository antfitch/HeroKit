...
{
    /// <summary>
    /// Toggle the state of the canvas on a UI object.
    /// </summary>
    public class ToggleCanvas : IHeroKitAction
    {
        ...
        public static ToggleCanvas Create()
        {
            ToggleCanvas action = new ToggleCanvas();
            return action;
        }
