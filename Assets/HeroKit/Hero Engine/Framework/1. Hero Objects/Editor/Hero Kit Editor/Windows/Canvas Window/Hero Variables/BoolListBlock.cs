...
{
    /// <summary>
    /// Block for Hero Object variables (bools) that appear in Hero Kit Editor.
    /// </summary>
    internal static class BoolListBlock
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private static string blockName = "Bool";
        /// <summary>
        /// Show the tools menu.
        /// </summary>
        private static bool showTools;
        /// <summary>
        /// List of fields in the bool list.
        /// </summary>
        private static List<BoolField> items;
        /// <summary>
        /// List of bool fields that were copied (and can be pasted somewhere).
        /// </summary>
        private static List<BoolField> savedFieldList;
        /// <summary>
        /// List of the most recently deleted bool fields.
        /// </summary>
        private static LinkedList<BoolField> deletedFields;
        /// <summary>
        /// List of the index values for the most recently deleted bool fields.
        /// The index tells us where the bool field was in the list before it was deleted.
        /// </summary>
        private static LinkedList<int> deletedFieldsIndex;
        /// <summary>
        /// The smallest number of items that can be copied or deleted in a bool list.
        /// </summary>
        private static int rangeBottom;
        /// <summary>
        /// The largest number of items that can be copied or deleted in a bool list.
        /// </summary>
        ...
        /// Constructor.
        /// </summary>
        static BoolListBlock()
        {
            // create deleted field list
            deletedFields = new LinkedList<BoolField>();
        ...
        {
            HeroKitCommon.addItem(items, new BoolField());
        }
        /// <summary>
        ...
        {
            HeroKitCommon.addItem(items, new BoolField(), index);
        }
        ...
        {
            savedFieldList = HeroKitCommon.copyItem(new BoolField(items[index]));
        }
        /// <summary>
