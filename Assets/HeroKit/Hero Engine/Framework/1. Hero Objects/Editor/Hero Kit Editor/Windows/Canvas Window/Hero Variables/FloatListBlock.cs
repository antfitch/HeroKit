...
{
    /// <summary>
    /// Block for Hero Object variables (floats) that appear in Hero Kit Editor.
    /// </summary>
    internal static class FloatListBlock
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private static string blockName = "Float";
        /// <summary>
        /// Show the tools menu.
        /// </summary>
        private static bool showTools;
        /// <summary>
        /// List of fields in the float list.
        /// </summary>
        private static List<FloatField> items;
        /// <summary>
        /// List of float fields that were copied (and can be pasted somewhere).
        /// </summary>
        private static List<FloatField> savedFieldList;
        /// <summary>
        /// List of the most recently deleted float fields.
        /// </summary>
        private static LinkedList<FloatField> deletedFields;
        /// <summary>
        /// List of the index values for the most recently deleted float fields.
        /// The index tells us where the float field was in the list before it was deleted.
        /// </summary>
        private static LinkedList<int> deletedFieldsIndex;
        /// <summary>
        /// The smallest number of items that can be copied or deleted in a float list.
        /// </summary>
        private static int rangeBottom;
        /// <summary>
        /// The largest number of items that can be copied or deleted in a float list.
        /// </summary>
        ...
        /// Constructor.
        /// </summary>
        static FloatListBlock()
        {
            // create deleted field list
            deletedFields = new LinkedList<FloatField>();
        ...
        public static void Block(HeroObject heroKitObject, bool globals = false)
        {
            ...
            items = (globals) ? HeroKitCommon.GetGlobals().globals.floats.items : heroObject.lists.floats.items;
        ...
        public static void Block(HeroKitProperty heroKitProperty)
        {
            ...
            // assign hero object to this class
            items = heroKitProperty.properties.floats.items;
        ...
        {
            HeroKitCommon.DrawBlockTitle("Float List");
        }
        /// <summary>
        /// Draw the block.
        /// </summary>
        ...
        private static void DrawItems()
        {
            ...
            for (int i = 0; i < items.Count; i++)
            {
                ...
                items[i].value = SimpleLayout.FloatListField(items[i], i);
        ...
        {
            HeroKitCommon.addItem(items, new FloatField());
        }
        /// <summary>
        ...
        {
            HeroKitCommon.addItem(items, new FloatField(), index);
        }
        ...
        {
            savedFieldList = HeroKitCommon.copyItem(new FloatField(items[index]));
        }
        /// <summary>
