...
{
    /// <summary>
    /// Block for Hero Object variables (game object) that appear in Hero Kit Editor.
    /// </summary>
    internal static class GameObjectListBlock
    {
        // --------------------------------------------------------------
        // Variables
        // --------------------------------------------------------------
        ...
        /// Name of the block.
        /// </summary>
        private static string blockName = "Game Object";
        /// <summary>
        /// Show the tools menu.
        /// </summary>
        private static bool showTools;
        /// <summary>
        /// List of fields in the game object list.
        /// </summary>
        private static List<GameObjectField> items;
        /// <summary>
        /// List of game object fields that were copied (and can be pasted somewhere).
        /// </summary>
        private static List<GameObjectField> savedFieldList;
        /// <summary>
        /// List of the most recently deleted game object fields.
        /// </summary>
        private static LinkedList<GameObjectField> deletedFields;
        /// <summary>
        /// List of the index values for the most recently deleted game object fields.
        /// The index tells us where the game object field was in the list before it was deleted.
        /// </summary>
        private static LinkedList<int> deletedFieldsIndex;
        /// <summary>
        /// The smallest number of items that can be copied or deleted in a game object list.
        /// </summary>
        private static int rangeBottom;
        /// <summary>
        /// The largest number of items that can be copied or deleted in a game object list.
        /// </summary>
        ...
        /// Constructor.
        /// </summary>
        static GameObjectListBlock()
        {
            // create deleted field list
            deletedFields = new LinkedList<GameObjectField>();
        ...
        public static void Block(HeroObject heroKitObject, bool globals = false)
        {
            ...
            items = (globals) ? HeroKitCommon.GetGlobals().globals.gameObjects.items : heroObject.lists.gameObjects.items;
        ...
        public static void Block(HeroKitProperty heroKitProperty)
        {
            ...
            // assign hero object to this class
            items = heroKitProperty.properties.gameObjects.items;
        ...
        {
            HeroKitCommon.DrawBlockTitle("Game Object List");
        }
        /// <summary>
        /// Draw the block.
        /// </summary>
        ...
        {
            HeroKitCommon.addItem(items, new GameObjectField());
        }
        /// <summary>
        ...
        {
            HeroKitCommon.addItem(items, new GameObjectField(), index);
        }
        ...
        {
            savedFieldList = HeroKitCommon.copyItem(new GameObjectField(items[index]));
        }
        /// <summary>
