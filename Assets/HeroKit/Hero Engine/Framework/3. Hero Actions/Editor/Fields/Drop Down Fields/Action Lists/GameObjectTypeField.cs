...
{
    /// <summary>
    /// Drop down list. Get the location of a game object.
    /// </summary>
    public class GameObjectTypeField : IDropDownList
    {
        // create field
        ...
        private void PopulateField()
        {
            ...
            string[] items = {
                "This Game Object",
                "Game Object (In Variable List)",
                "Game Object (In Scene)",
                "Game Object (In Property List)",
            };
        ...
        public GameObjectTypeField() { PopulateField(); }
