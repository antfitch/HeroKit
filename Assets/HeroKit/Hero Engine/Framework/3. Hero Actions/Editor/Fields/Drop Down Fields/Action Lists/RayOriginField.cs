...
{
    /// <summary>
    /// Drop down list. Get the origin of a ray. 
    /// </summary>
    public class RayOriginField : IDropDownList
    {
        // create field
        ...
        {
            string name = "Ray Type";
            string[] items = {
                "Shoot ray from main camera",
                "Shoot ray from camera on hero object",
                "Shoot ray from hero object",
            };
        ...
        public RayOriginField() { PopulateField(); }
