...
{
    /// <summary>
    /// Drop down list. Get an input type.
    /// </summary>
    internal static class EventInputTypeField
    {
        // create field
        ...
        static EventInputTypeField() { PopulateField(); }
        ...
        {
            int result = SimpleLayout.DropDownList(heroObject.states.states[stateIndex].heroEvent[eventIndex].inputConditions[listIndex].items[conditionIndex].inputType, field, titleWidth);
