...
{
    /// <summary>
    /// Action field for the hero kit editor. Work with hero properties.
    /// </summary>
    public static class GetHeroPropertyField
    {
        // --------------------------------------------------------------
        // Action Fields
        // --------------------------------------------------------------
    ...
    /// <summary>
    /// Data needed for a GetHeroPropertyField.
    /// </summary>
    public struct HeroPropertyFieldData : ITitle
    {
        ...
        public HeroKitProperty fieldValue;
    }
}