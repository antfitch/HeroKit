...
{
    /// <summary>
    /// Action field for the hero kit editor. Work with layer masks.
    /// </summary>
    public static class GetLayerMaskValue
    {
        // --------------------------------------------------------------
        // Action Fields
        // --------------------------------------------------------------
    ...
    /// <summary>
    /// Data needed for GetLayerMaskValue.
    /// </summary>
    public struct LayerMaskValueData : ITitle
    {
