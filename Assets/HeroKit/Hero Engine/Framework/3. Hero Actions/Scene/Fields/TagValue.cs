...
{
    /// <summary>
    /// Get a tag from a tag field.
    /// </summary>
    public static class TagValue
    {
        /// <summary>
        /// Get a value from a tag field.
        /// </summary>
        ...
        /// <returns>The value for the tag.</returns>
        public static string GetValue(HeroKitObject heroKitObject, int actionFieldID)
        {
            // Get the action
            ...
            // Get the value
            string value = action.actionFields[actionFieldID].strings[0];
