...
namespace HeroKit.Scene.Actions
{
    ...
    /// Show a message.
    /// </summary>
    public class ShowDialogB : IHeroKitAction
    {
        ...
        public static ShowDialogB Create()
        {
            ShowDialogB action = new ShowDialogB();
            return action;
        }
        ...
        public int Execute(HeroKitObject hko)
        {
            ...
            if (runThis)
            {
                ...
                if (uiDialog.addChoices)
                {
                    ...
                    //            if (uiDialog.numberOfChoices >= 4)
                    //            {
                    //                uiDialog.choice[3] = StringFieldValue.GetValueA(heroKitObject, 35, true);
                    //            }
                    //        }
                    //    }
                    //}
